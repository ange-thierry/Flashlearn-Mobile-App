...
class _FieldsScreenState extends State<FieldsScreen> {
  ...
  // Bottom nav: 0=Home 1=Saved 2=Awards 3=Alerts 4=Profile
  ...
  void _onNavTap(BuildContext context, AppProvider prov, int index) {
    ...
    else if (index == 4) _openProfileSheet(context, prov);
  }
  ...
  Widget _heroHeader(BuildContext context, AppProvider prov, {required bool wide}) {
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(20, 14, wide ? 20 : 62, 24),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // ── App name row ────────────────────────────────────────────────
  ...
  // â"€â"€ UPCOMING CLASSES â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€
  ...
  // â"€â"€ IN PROGRESS â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€â"€
  ...
  Widget _dailyGoalsCard(BuildContext context, AppProvider prov) {
    ...
    final done   = prov.dailyCards[todayKey] ?? 0;
    const goal   = 10;
    ...
    void setGoals() {
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: const Text('Daily Goal', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
          content: const Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.track_changes_rounded, size: 44, color: AppTheme.primary),
              SizedBox(height: 12),
              Text('Your daily goal is set to 10 cards.\nKeep studying consistently!',
